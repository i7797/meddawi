...
const FinalService = () => {
  ...
  return (
    <>
      <div className="ServiceContainer md:bg-[#181D3D] lg:bg-[#181D3D] grid grid-cols-12 grid-rows-[auto,auto,1fr] lg:h-[70%] h-screen w-screen justify-items-center overflow-x-hidden   ">
      
        <div
          id="service"
          className="w-[90%] h-[30%] lg:w-full lg:h-[20%] mt-[50px] lg:mt-0 md:hidden lg:hidden  "
        >
          <NavBar />
        </div>
        ...
        <div className="Servicecards mt-10 col-span-12 row-start-3 w-full grid gap-5 p-4 grid-cols-1 sm:grid-cols-2  md:grid-cols-3 lg:grid-cols-3 ">
          {data.map((e, index) => (
