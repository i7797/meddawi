...
function NavBar() {
  return (
    <div className='Nab-bg bg-[#090950] lg:bg-inherit	flex justify-center items-start'>
    <div className='nav  flex bg-[#323868] w-[95%]  rounded-[20px] mt-[40px] lg:flex-row-reverse'>
   ...
   <li >
          ...
          <Link className='' to="/profile">صفحه  الشخصية    </Link>
   </li>
        <Link to='/team'>
