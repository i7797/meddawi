...
function ServiceCardFinal({ data }) {
  return (
    <div
      key={data.id}
      className="service-card bg-[#F7F7F7] md:bg-[#323868] lg:bg-[#323868] xl:bg-[#323868] 2xl:bg-[#323868] border-2 flex flex-col items-center justify-between w-full md:w-auto lg:w-auto xl:w-auto mb-8 p-6 rounded-2xl shadow-xl"
    >
      ...
      <div className="text text-center p-3">
        ...
        <p className="description text-gray-700 md:text-white lg:text-white xl:text-white 2xl:text-white mb-4">
          {data.text}
        </p>
      </div>
    </div>
